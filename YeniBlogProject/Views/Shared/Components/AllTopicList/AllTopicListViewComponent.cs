...
namespace YeniBlogProject.Views.Shared.Components.AllTopicList
{
    public class AllTopicListViewComponent:ViewComponent
    {
        private readonly YeniBlogDbContext _context;
        TopicRep topicRep;
        public AllTopicListViewComponent(YeniBlogDbContext context)
        {
            _context = context;
